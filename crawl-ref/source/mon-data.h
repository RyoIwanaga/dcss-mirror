...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_ARCHER | M_DONT_MELEE | M_SPELLCASTER | M_ACTUAL_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    { 14, 5, 4, 0 },
    9, 10, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_ROAR,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 5, 4, 0 },
    9, 14, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 5, 4, 0 },
    8, 10, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED
},
...

{
    ...
    { 16, 6, 3, 0 },
    -3, 10, MST_NO_SPELLS, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    -1, 0, MST_DEEP_ELF_ANNIHILATOR, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED
},
...

{
    ...
    { 5, 3, 5, 0 },
    6, 13, MST_NO_SPELLS, CE_POISONOUS, Z_SMALL, S_BARK,
    I_ANIMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED
},
...

{
    ...
    { 6, 3, 5, 0 },
    3, 12, MST_NO_SPELLS, CE_CLEAN, Z_BIG, S_SILENT,
...

{
    ...
    M_WARM_BLOOD | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS | M_SEE_INVIS,
    MR_NO_FLAGS,
...

{
    ...
    M_SPELLCASTER | M_WARM_BLOOD | M_SPEAKS | M_FAKE_SPELLS | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
...

{
    ...
    M_SPELLCASTER | M_WARM_BLOOD | M_SPEAKS | M_ACTUAL_SPELLS | M_SEE_INVIS,
    MR_NO_FLAGS,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_SPEAKS | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_SPELLCASTER | M_PRIEST | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    { 8, 4, 5, 0 },
    9, 6, MST_NO_SPELLS, CE_POISONOUS, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED // ??
},
...

{
    ...
    { 9, 3, 5, 0 },
    0, 10, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_WINGED, 12, DEFAULT_ENERGY,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_SPEAKS | M_NOISY_SPELLS,
...

{
    ...
    M_SPELLCASTER | M_WARM_BLOOD | M_FAKE_SPELLS | M_NOISY_SPELLS,
    MR_RES_STEAM,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_FAKE_SPELLS | M_NOISY_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_FAKE_SPELLS
        | M_UNBREATHING | M_NOISY_SPELLS,
...

{
    ...
    M_SHADOW | M_SPELLCASTER | M_SEE_INVIS | M_COLD_BLOOD
        | M_FAKE_SPELLS | M_NOISY_SPELLS,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_GLOWS_LIGHT | M_NOISY_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_ASPHYX,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_RADIATION,
    MR_RES_ASPHYX,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 26}, {AT_CLAW, AF_PLAIN, 14}, {AT_CLAW, AF_PLAIN, 14},
       AT_NO_ATK },
    { 9, 3, 5, 0 },
    5, 7, MST_NO_SPELLS, CE_CLEAN, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED
},
...

{
    ...
    M_SPELLCASTER | M_WARM_BLOOD | M_SPEAKS | M_ACTUAL_SPELLS | M_NO_POLY_TO,
    MR_VUL_FIRE,
...

{
    ...
    { 10, 3, 5, 0 },
    2, 15, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_HISS,
...

{
    ...
    M_NO_SKELETON | M_FIGHTER | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER | M_ACTUAL_SPELLS | M_FIGHTER,
    MR_NO_FLAGS,
    550, 10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 1, 0 },
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER | M_PRIEST | M_FIGHTER,
    MR_NO_FLAGS,
    550, 10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 1, 2, 0 },
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER | M_PRIEST | M_SEE_INVIS,
    MR_NO_FLAGS,
    550, 10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 0, 0 },
...
{
    MONS_RUST_DEVIL, '4', CYAN, "rust devil",
    M_NO_FLAGS,
    MR_RES_POISON | mrd(MR_RES_ELEC, 2) | MR_RES_HELLFIRE | MR_RES_COLD,
    0, 10, MONS_RUST_DEVIL, MONS_RUST_DEVIL, MH_DEMONIC, 60,
    { {AT_TOUCH, AF_CORRODE, 4}, {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_SHADOW,
...
// gargoyles ('9')
{
    ...
    M_ARTIFICIAL | M_SPELLCASTER | M_FAKE_SPELLS,
...

{
    ...
    M_ARTIFICIAL | M_SEE_INVIS | M_SPELLCASTER | M_FAKE_SPELLS | M_FIGHTER,
...
// "c"entaurs.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_ARCHER | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS,
    MR_NO_FLAGS,
...
// "D"ragons and hydras.
{
    ...
    M_UNIQUE | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_NOISY_SPELLS,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2) | MR_VUL_COLD,
    2400, 18, MONS_DRAGON, MONS_FIRE_DRAGON, MH_NATURAL, 180,
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 17},
      {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK },
    { 19, 0, 0, 133 },
    15, 7, MST_NO_SPELLS, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_NORMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_UNIQUE | M_FAKE_SPELLS | M_NOISY_SPELLS,
...

{
    ...
    M_SPELLCASTER | M_PRIEST | M_HYBRID | M_WARM_BLOOD | M_SPEAKS
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 200 },
    3, 10, MST_DAEVA, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    M_UNIQUE | M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SEE_INVIS
        | M_SPEAKS,
    MR_NO_FLAGS,
    550, 12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 140,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 21, 0, 0, 159 },
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 22, 0, 0, 164 },
    0, 10, MST_EFREET, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
