...

{
    ...
    MR_NO_FLAGS,
    550, 8, MONS_FAUN, MONS_FAUN, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 4, 0 },
...

{
    ...
    MR_NO_FLAGS,
    0, 10, MONS_VINE_STALKER, MONS_VINE_STALKER, MH_NATURAL, -4,
...

{
    ...
    mrd(MR_RES_ELEC, 3),
    450, 12, MONS_HOUND, MONS_RAIJU, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    600, 12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, -6,
...

{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    220, 13, MONS_RAT, MONS_RIVER_RAT, MH_NATURAL, -3,
...

{
    ...
    MR_RES_POISON,
    0, 13, MONS_WORLDBINDER, MONS_WORLDBINDER, MH_NONLIVING, -6,
...

{
    ...
    M_SHADOW | M_SPELLCASTER | M_SEE_INVIS | M_COLD_BLOOD | M_FAKE_SPELLS,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_GLOWS_LIGHT,
    MR_NO_FLAGS,
...

{
    ...
    MR_RES_COLD,
    0, 16, MONS_UNBORN, MONS_UNBORN, MH_UNDEAD, -8,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 5, 4, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    100, 13, MONS_SNAKE, MONS_BALL_PYTHON, MH_NATURAL, -1,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    200, 10, MONS_SNAKE, MONS_ADDER, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD,
    mrd(MR_RES_ELEC, 3),
    400, 12, MONS_SNAKE, MONS_SHOCK_SERPENT, MH_NATURAL, -3,
...

{
    ...
    M_SENSE_INVIS | M_INSUBSTANTIAL | M_SPEAKS,
    mrd(MR_RES_COLD, 3),
    0, 8, MONS_GHOST, MONS_DROWNED_SOUL, MH_UNDEAD, -4,
...

{
    ...
    0, 18, MONS_GARGOYLE, MONS_WAR_GARGOYLE, MH_NONLIVING, -6,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 2, 4, 0 },
...

{
    ...
    MR_NO_FLAGS,
    900, 15, MONS_MINOTAUR, MONS_MINOTAUR, MH_NATURAL, -5,
    { {AT_HIT, AF_PLAIN, 40}, {AT_GORE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    { 15, 0, 0, 150 },
    5, 7, MST_ASTERION, CE_CLEAN, Z_SMALL, S_BELLOW,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
