...
{   // Base draconian - for use like MONS_HUMAN, MONS_ELF although we
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 6, 4, 0 },
    10, 11, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_ROAR, I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { 20, 5, 5, 0 },
    10, 15, MST_BLINKER, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { 6, 1, 2, 0 },
    5, 20, MST_BLINKER, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
...

{
    ...
    { 13, 3, 5, 0 },
    8, 10, MST_DRAIN_GAZE, CE_MUTAGEN, Z_BIG, S_SILENT,
...

{
    ...
    { 6, 3, 5, 0 },
    0, 16, MST_BLINKER, CE_CLEAN, Z_SMALL, S_CROAK,
...
// eyes ('G')
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    0, 1, MST_GIANT_EYEBALL, CE_CLEAN, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    3, 1, MST_DRAIN_GAZE, CE_POISONOUS, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 1, 2, 0 },
    0, 20, MST_GOLDEN_EYE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 13, DEFAULT_ENERGY,
...
// dangerous, but still come out at 200+ XP
{
    ...
    { 7, 3, 5, 0 },
    3, 13, MST_BLINKER, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...
// minor demons: imps, etc. ('5')
{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 3, 0 },
    3, 14, MST_BLINKER, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...
{
    MONS_NAWAB, 'g', RED, "Nawab Begum",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    500, 10, MONS_GOBLIN, MONS_HOBGOBLIN, MH_NATURAL, 10,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 0, 0, 16 },
    1, 8, MST_NAWAB, CE_CLEAN, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...
// Rakshasas and demons.
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 0, 0, 88 },
    10, 5, MST_AZRAEL, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE, MON_SHAPE_HUMANOID
},
...
// unique major demons ('&')
{
    ...
    { {AT_HIT, AF_KLOWN, 40}, {AT_HIT, AF_MUTATE, 35}, {AT_HIT, AF_VULN, 30},
      {AT_HIT, AF_BLINK, 23} },
    { 17, 0, 0, 350 },
